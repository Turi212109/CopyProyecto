                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                              <label for="txtRucProveedor" class="col-form-label col-form-label-sm">RFC:</label>
                                              <input type="text" class="form-control form-control-sm model" readonly id="txtRucProveedor" name="RFC">
                                            </div>
                                          </div>
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                ...
                                <div class="card">
                                  <div class="card-body p-2">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                              <label for="txtRucTienda" class="col-form-label col-form-label-sm">RFC:</label>
