          ...
          <div class="modal-body">
            <form>
              ...
              <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label col-form-label-sm">RFC</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control form-control-sm model" id="txtRuc" name="RFC">
                </div>
              </div>
              <div class="form-group row">
